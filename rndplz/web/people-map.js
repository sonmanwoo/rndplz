(function(root,factory){
 ...
 function mount(doc,host){
  ...
  function mobile(){
   ...
   if(button){button.setAttribute('aria-pressed',String(mobileMap));button.textContent=mobileMap?'인물 목록 보기':'연결 지도 보기';}
  }
  function render(){
